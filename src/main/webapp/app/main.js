System.register(['angular2/platform/browser', './components/app.component', "angular2/router", "angular2/http", "angular2/core", "./libraries/angular2-jwt", "./services/sign-in.service", "./services/token.service", "./services/sing-up.service"], function(exports_1) {
    var browser_1, app_component_1, router_1, http_1, core_1, angular2_jwt_1, sign_in_service_1, token_service_1, sing_up_service_1;
    return {
        setters:[
