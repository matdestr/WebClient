System.register(['angular2/core', 'angular2/router', "../authentication/sign-out.component", "../../services/user.service", "../../libraries/angular2-jwt", "../../entities/user"], function(exports_1) {
    ...
    var core_1, router_1, sign_out_component_1, user_service_1, angular2_jwt_1, user_1;
