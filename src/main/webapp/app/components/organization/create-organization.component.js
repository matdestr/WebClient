System.register(['angular2/core', "angular2/common", "angular2/router", "../../entities/user", "../../services/organization.service", "../../entities/organization", "../widget/toolbar.component", "../widget/error-dialog.component"], function(exports_1) {
